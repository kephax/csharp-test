...
namespace RefactoringGeometricalShapes
{
  ...
  public class ShapeTest
  {
    ...
    public void testReportForOneSquare()
    {
      ...
      shapes.Add(new Shape( Shape.shapes_list["SQUARE"], 1) );
    ...
    public void testReportForMoreSquares()
    {
      List<Shape> shapes = new List<Shape>();
            shapes.Add(new Shape(Shape.shapes_list["SQUARE"], 1));
      shapes.Add(new Shape(Shape.shapes_list["SQUARE"], 2));
    ...
    {
      List<Shape> shapes = new List<Shape>();
      shapes.Add(new Shape(Shape.shapes_list["CIRCLE"], 1));
      shapes.Add(new Shape(Shape.shapes_list["SQUARE"], 1));
      shapes.Add(new Shape(Shape.shapes_list["EQUILATERAL_TRIANGLE"], 2));
      shapes.Add(new Shape(Shape.shapes_list["SQUARE"], 2));
      shapes.Add(new Shape(Shape.shapes_list["SQUARE"], 3));
      shapes.Add(new Shape(Shape.shapes_list["CIRCLE"], 2));
